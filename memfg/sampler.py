...
class Sampler:
    def __init__(self,dsphdata,model,param_names,init_low,init_high):
        ...
        self.photometry_model = modki17.modKI17_photometry(dsphdata.sc_photo,dsphdata.dsph_prop_sc,model=model)
    ...
    def wbic_init_sampler(self,nwalkers=16):
        ...
        self.wbic_sampler = MyEnsembleSampler(
            nwalkers=nwalkers, dim=self.n_param,
            lnpostfn=self.photometry_model.lnposterior_general, threads=16)
